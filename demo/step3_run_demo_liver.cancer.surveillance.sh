...
input_samples_file="./input/example_liver.cancer.surveillance_sample.csv"
...
input_data_file="./input/example_liver.cancer.surveillance_data.csv"

# Output prediction file (comma-separated text file)
out_pred_file="./output/example_liver.cancer.surveillance_pred.csv"

Rscript ../src/liver.cancer.surveillance.R \
    $input_samples_file \
