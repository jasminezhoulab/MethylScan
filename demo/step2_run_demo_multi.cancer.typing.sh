...
# Rows: samples
# Columns used: sample_id, cancer_status (cancer or normal), cancer_type (cancer types or normal), train_or_test (train or test)
# This file allows to have other irrelevant columns
input_samples_file="./input/example_multi.cancer.typing_sample.csv"
...
input_data_file="./input/example_multi.cancer.typing_data.csv"

# Output prediction file (comma-separated text file)
out_pred_file="./output/example_multi.cancer.typing_pred.csv"

Rscript ../src/multi.cancer.typing.R \
    $input_samples_file \
